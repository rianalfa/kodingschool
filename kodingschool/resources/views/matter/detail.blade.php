    ...
    @if (!empty($matter->instruction))
        <div class="w-full mt-5">
            <div class="w-full bg-gray-300 rounded-t-lg py-2 px-4">
                <p class="text-gray-700 text-lg font-bold">Instruksi</p>
            </div>
